...
window.history.replaceState(null, "", window.location.href);
  ...
  return (
    <div className="flex bg-custom_yellow py-3 px-8 items-center justify-between font-Poppins shadow-2xl">
      {/* Logo */}
      <Link to="/supportstaff-dashboard" className="flex items-center">
        <img
          src={tigertix_logo}
      ...
      <div className="flex items-center gap-4">
        <span className="text-gray-800 font-medium">Hi, Support Staff!</span>
...
export default Header_SupportStaff;
